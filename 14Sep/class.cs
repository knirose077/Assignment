...
namespace sep14lib
{
    ...
    public class Searching
    {
        ...
        {
            movies.Add(new Movie("peramem", "malayalam", "Love", 20));
            movies.Add(new Movie("AO", "Tamil", "Mistory", 18));
            movies.Add(new Movie("KGF", "Telugu", "Action", 8));
            movies.Add(new Movie("rajastan", "Hindi", "Love", 20));
            movies.Add(new Movie("Pollatavan", "Tamil", "Action", 14));
        }
        public void search()
        {
